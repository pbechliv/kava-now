...
#
# Brand mark: solid amber squircle (amber-600 #d97706, matching the
# `text-primary` wordmark) with a white amphora — the ancient Greek vessel
# that shipped wine across the Mediterranean, i.e. the original κάβα
# logistics. A partial-width "pottery band" is cut out of the belly via mask
# so the silhouette stays connected at small sizes. Keep the artwork in sync
